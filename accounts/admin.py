...
admin.site.register(WandererPreferenceWalkingPace)
admin.site.register(WalkerWalkingPace)
admin.site.register(WalkerLanguage)
admin.site.register(WandererPreferenceLanguage)
